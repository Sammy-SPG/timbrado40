...
function ___cancelacion2022($datos)
{
    ...
    //$url_webservice="http://idventa.ddns.net/ws_cancelar/cancelacion2022?wsdl";
    $url_webservice="http://pac1.multifacturas.com/cancelacion2022/?wsdl";
  ...
  switch ($accion) {
    ...
    case 'CANCELAR':
        ...
        $datos2["motivo"]=$datos["motivo"];
        $datos2["folioSustitucion"]=$datos["folioSustitucion"];
        $datos2["uuid"]=$uuid;
