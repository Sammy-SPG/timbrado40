<?php
$postfijo = mf_postfijo_php();
if($postfijo === false)
{
    throw new \Exception("Esta version de php no es compatible con el SDK");
}
else
{
    // Se agrega el archivo de funciones
    $rutaFunciones = $__mf_constantes__['__MF_NODOS_DIR__'] . 'cfdi' . '/funciones' . $postfijo . '.php';
    ...
    {
        throw new \Exception("ERROR Requiere archivo $rutaFunciones ");
    }
