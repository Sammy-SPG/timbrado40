...
//LEE VARIABLES
    ...
    if(isset($datos['factura']))
    {
        ...
        $atrsRetenciones .= "xmlns:retenciones=\"http://www.sat.gob.mx/esquemas/retencionpago/1\" $ns_arrendamientoenfideicomiso $ns_dividendos $ns_intereses $ns_enajenaciondeacciones $ns_operacionesconderivados xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.sat.gob.mx/esquemas/retencionpago/1 http://www.sat.gob.mx/esquemas/retencionpago/1/retencionpagov1.xsd $sl_arrendamientoenfideicomiso $sl_operacionesconderivados $sl_enajenaciondeacciones $sl_intereses $sl_dividendos\" ";
