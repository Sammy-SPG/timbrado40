...
/** @var app\models\form\IngresoForm $model */

$this->title = 'Timbrar Factura de Ingreso (I)';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="site-ingresos">
    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        Complete el siguiente formulario para generar un CFDI 4.0 de Ingreso.
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-header">
                    <h4 class="mb-0">3. Concepto (Simple)</h4>
                    <small>Para este demo, solo se permite un concepto.</small>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="form-group text-center">
                <?= Html::submitButton('Timbrar CFDI de Ingreso', ['class' => 'btn btn-primary btn-lg']) ?>
            </div>
